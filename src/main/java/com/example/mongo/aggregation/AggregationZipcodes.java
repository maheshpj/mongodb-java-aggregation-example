 ...
 * 
 */
public class AggregationZipcodes {

	public static void main(String[] args) {
		DB db = MongoDb.getTestDb();
	 ...
	 */
	private static void statesWithPopulationsOver10Million(DBCollection zipcodes) {
	 ...
	 */
	private static void averageCityPopulationByState(DBCollection zipcodes) {
	 ...
	 */
	private static void largestAndSmallestCitiesByState(DBCollection zipcodes) {
		DBObject idFields = new BasicDBObject("state", "$state");
		idFields.put("city", "$city");
		DBObject groupFields1 = new BasicDBObject("_id", idFields);
		groupFields1.put("pop", new BasicDBObject("$sum", "$pop"));
